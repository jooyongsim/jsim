function varargout = impixel1(varargin)
...
%   All other inputs are double. 
%
%   The output P is single if the input image is not double.  Otherwise,
%   the output P is double.  The rest of the outputs are double.
%
%   Example
%   -------
...
%   $Revision: 5.23.4.7 $  $Date: 2006/06/15 20:09:02 $

[a,cm,xi,yi,x,y] = parse_inputs(varargin{:});

iptcheckinput(a,{'uint8' 'uint16' 'double' 'logical' 'single' 'int16'}, ...
...
iptchecknargin(0, 6, nargin, mfilename);
